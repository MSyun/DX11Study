...
namespace MSLib {
	...
	void DXApplication::PreMainWnd() {
		...
		m_cs.dwExStyle = 0;
		m_cs.lpszName = _T("DirectX11Application");
		m_cs.style = !Screen::GetFullScreen() ? WS_OVERLAPPEDWINDOW | WS_VISIBLE : WS_POPUP | WS_VISIBLE;
		m_cs.x = (int)(rcRect.right * 0.5f - width * 0.5f);
		m_cs.y = (int)(rcRect.bottom * 0.5f - height * 0.5f);
		...
		m_cs.hwndParent = nullptr;
		m_cs.hMenu = nullptr;
		m_cs.lpCreateParams = nullptr;
	}
